...
#include "AbilityTaskPlayMontageAndWaitForEvent.generated.h"
 ...
 */
UCLASS()
class CREATUREOASIS_API UAbilityTaskPlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
	
public:
	// Constructor and overrides
	UAbilityTaskPlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	static UAbilityTaskPlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
